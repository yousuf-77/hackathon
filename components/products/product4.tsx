...
export default function Product4() {
  return (
    <div className="llg:w-[285px] xs:w-[270.75px] llg:h-[446px] xs:h-[423.7px] w-full aspect-[30/47]  relative object-cover ">
      ...
      <div className="w-full aspect-[285/301] llg:h-[301px] xs:h-[285.95px] bg-[url('/images/products-img/sofa-set.svg')] bg-center bg-contain bg-no-repeat flex">
      ...
      <div className="llg:h-[145px] xs:h-[137.75px] aspect-[57/29] w-full  p-4 bg-[#F4F5F7]">
        <div className="w-[89.3684%] llg:min-h-[99px] xs:min-h-[94.05px]">
          <div className="w-full llg:h-[61px]      xs:h-[57.95px] flex flex-col justify-between xs:justify-around ">
            <p className="llg:text-[24px] xs:text-[22.8px] font-semibold llg:leading-[28.8px] xs:leading-[27.36px] text-left text-[#3A3A3A]">
              Respira
            </p>
            <p className="llg:text-base xs:text-[15.2px] font-medium llg:leading-6 xs:leading-[5.7px] xs:text-nowrap text-left text-[#898989]">
