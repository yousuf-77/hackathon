...
export default function Product7() {
  return (
    <div className="llg:w-[285px] xs:w-[270.75px] llg:h-[446px] xs:h-[423.7px] w-full aspect-[30/47]  relative object-cover ">
      ...
      <div className="w-full aspect-[285/301] llg:h-[301px] xs:h-[285.95px] bg-[url('/images/products-img/pingky-sofa.svg')] bg-center bg-contain bg-no-repeat flex">
        <div className="w-full flex justify-end">
          <div className="llg:h-[48px] h-[45.6px] llg:w-[48px] w-[45.6px] bg-[#E97171] rounded-[50%] text-base font-medium llg:leading-6 xs:leading-[5.7px] flex justify-center llg:mt-[24px] mt-[22.8px] mr-[24px] items-center text-white">
            -50%
          </div>
        </div>
      </div>
      <div className="llg:h-[145px] xs:h-[137.75px] aspect-[57/29] w-full  p-4 bg-[#F4F5F7]">
        <div className="w-[87.3684%] llg:min-h-[99px] xs:min-h-[94.05px]">
          ...
          <div className="llg:mt-[8px] xs:mt-[8px] llg:h-[30px] xs:h-[28.5px] llg:w-[249px] xs:w-[236.55px] flex justify-between items-center flex-wrap">
            ...
            <p className="llg:text-base xs:text-[15.2px] font-normal llg:leading-6 xs:leading-[5.7px] text-left line-through underline-offset-auto decoration-slice text-[#B0B0B0]">
              Rp 14.000.000
            </p>
          </div>
        </div>
